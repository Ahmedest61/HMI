...
#    data['load'] = load
 ...
 #   json_file = "send.json" 
    ...
    output = subprocess.check_output(u'scp ' + json_file + ' root@155.245.23.55:/home/root/Netherland_Jan/Load_Generator/', shell=True)
    os.remove(json_file)
...
if __name__ == "__main__":
    app.run(host="155.245.23.126",port=5000)
